...
public class Student implements Serializable {
    ...
    private List<String> classIds; // Changed from Class object to classId
    ...
    // Constructor
    public Student(String studentId, String name, String gender, List<String> classIds, List<String> courseIds, Map<String, Grade> grades) {
